...
function renderCollection(){
  ...
  container.innerHTML="";
  const energy=filtered.filter(c=>c.group==="energy");
  const main=filtered.filter(c=>c.group!=="energy");
  appendGroup(container,"⚡ Energy Markers",energy,true);
...
function renderWish(){
  ...
  container.innerHTML="";
  appendGroup(container,"⚡ Energy Markers",arr.filter(c=>c.group==="energy"),true);
  appendGroup(container,"🃏 Main Set & Variants",arr.filter(c=>c.group!=="energy"),true);
