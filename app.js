...
function updateStats(){
 ...
 set("#ownedStat",o);set("#missingStat",t-o);set("#wishStat",w);set("#completionStat",p+"%");set("#ownedCount",o);set("#totalCount",t);set("#ownedCountHome",o);set("#totalCountHome",t);set("#wishCount",w);set("#progressPercentHome",p+"%");
 const ring=$("#progressRing");if(ring)ring.style.setProperty("--progress",p);
 const mainBar=$("#progressBarHome");if(mainBar)mainBar.style.width=p+"%";
...
window.addEventListener("load",()=>{
  window.setTimeout(()=>document.body.classList.add("app-ready"),1250);
});
window.setTimeout(()=>document.body.classList.add("app-ready"),2600);
